async function getFiveDay() {
    const url = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=be8753d36dab0642baf37a7f8906882f";
...
async function getCurrWeather() {
    const url = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&appid=be8753d36dab0642baf37a7f8906882f";
...
function events() {
    const data = getTownData()
        .then(function(town) {
            ...
            for (item of town["towns"][sd].events) {
                console.log(item)
